 ...
 * @package LydiaCore
 */
class Cjasse implements ISingleton {
    ...
    protected function __construct() {
        // include the site specific config.php and create a ref to $ja to be used by config.php
        $ja = &$this;
        require(jasse_SITE_PATH.'/config.php');
    }
    ...
    public function ThemeEngineRender() {
        ...
        $themePath    = jasse_INSTALL_PATH . "/themes/{$themeName}";
